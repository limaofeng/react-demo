...
if (location.pathname != "/index-rtl-fa.html" && location.pathname != "/index-rtl-ar.html") {
    if (readCookie("rtl-support")) {
        if (document.getElementById("beyond-link") != null)
            document.getElementById("beyond-link").setAttribute("href", __PUBLIC_URL__ + "/assets/css/beyond-rtl.min.css");
        if (document.getElementById("bootstrap-rtl-link") != null)
            document.getElementById("bootstrap-rtl-link").setAttribute("href", __PUBLIC_URL__ + "/assets/css/bootstrap-rtl.min.css");
        ...
        if (document.getElementById("beyond-link") != null)
            document.getElementById("beyond-link").setAttribute("href", __PUBLIC_URL__ + "/assets/css/beyond.min.css");
        if (document.getElementById("bootstrap-rtl-link") != null)
