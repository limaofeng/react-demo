...
class RemoveBanner extends Component {
  render() {
    ...
    return (
      <Popconfirm placement="left" title="是否确认删除 Banner ?" onConfirm={remove} okText="删除" cancelText="取消">
        <a>删除</a>
      </Popconfirm>
    );
  }
    ...
    return (
      <PageBody>
        <div className="table-box">
          ...
          <Table rowKey="id" loading={loading} columns={columns} dataSource={banners} />
        </div>
      </PageBody>
    );
  }
