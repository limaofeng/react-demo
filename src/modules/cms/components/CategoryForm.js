...
class CategoryForm extends Component {
    ...
    handleSubmit = e => {
      ...
      form.validateFieldsAndScroll((err, values) => {
        if (!err) {
          ...
          submit(values).then(({ data: { category: { id } } }) => {
    ...
    render() {
      const { visible, onCancel, form: { getFieldDecorator }, categoryTree, client, isedit, category: { parentId = false } } = this.props;
      return (
        <Modal
          visible={visible}
