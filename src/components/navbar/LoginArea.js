    ...
    return (
      <li>
            ...
            <section>
              <h2>
                <span className="profile">
                  <span>{user.nickName || 'David Stevenson'}</span>
                </span>
              </h2>
            </section>
          </div>
        ...
        <ul className="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
          ...
          <li className="email">
            <a>{(user.details && user.details.email) || 'David.Stevenson@live.com'}</a>
          </li>
          <li>
            <Avatar />
          </li>
          ...
          <li className="dropdown-footer edit">
            <a className="pull-left" onClick={this.changePwd} role="none">
              修 改 密 码
            </a>
            <a className="pull-right logout" onClick={this.logout} role="none">
              登 出
            </a>
          </li>
        </ul>
