        ...
        <div id="entry-controls">
          <div
            className={classnames('settings-menu settings-menu-pane', {
              'settings-menu-pane-in': !next,
              'settings-menu-pane-out-left': next
            })}
          >
          ...
          <div
            className={classnames('settings-menu settings-menu-pane', {
              'settings-menu-pane-in': next,
              'settings-menu-pane-out-right': !next
            })}
          >
            <div className="ember-view active">
              <div className="settings-menu-header subview">
                <button className="back settings-menu-header-action" onClick={this.handleCloseNextSettings}>
                  <Icon type="left" />
                </button>
                <h4>{extras.length && extras[nextIndex].props.title}</h4>
                <div />
              </div>
              <div className="settings-menu-content">{extras.length && extras[nextIndex]}</div>
            </div>
          </div>
        </div>
      </div>
